...
public class demoJobHandler {
     ...
     * 1、简单任务示例（Bean模式）
     */
    @XxlJob("hours_domainreliability")
    public ReturnT<String> hours_domainreliabilityJobHandler(String param) throws Exception {
        XxlJobLogger.log("XXL-JOB, hours_domainreliabilityJobHandler Start.");
